...
bool PriorityQueueX<T>::enqueue(T* value, size_t nPriority)
{
	...
	// Я знаю, что это тупо, если это осталось в релизе, значит я не смог задебажить
	// блок со вставкой элемента в нужную позицию.
	// Даю слово, что займусь этим сразу как разгребу отстающие дз.
	sort();
